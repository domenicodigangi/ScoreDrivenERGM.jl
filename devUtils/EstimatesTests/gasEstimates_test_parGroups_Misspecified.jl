...
useStartVal = true#false#  false
N = 10 ;
GBAdgp =1; GWdgp = 1 ;
GBAest =GBAdgp; GWest = GWdgp;
...
realUm , dgpdegs  =   DynNets.linSpacedPar( DynNets.fooSdErgm1,N; NgroupsW = GWdgp)
...
#   ind=1
 ...
 #n=1
    ...
    @save(save_path,groupsIndsEst,groupsIndsDgp,allObs,dgpdegs,simPar_1,simPar_2,simPar_3,estPar_1,estPar_2,estPar_3,est_conv_flag,est_times)
